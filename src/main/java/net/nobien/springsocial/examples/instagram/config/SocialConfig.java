...
import net.nobien.springsocial.examples.instagram.user.SecurityContext;
import net.nobien.springsocial.examples.instagram.user.SimpleConnectionSignUp;
import net.nobien.springsocial.examples.instagram.user.SimpleSignInAdapter;
import net.nobien.springsocial.examples.instagram.user.User;
...
public class SocialConfig {
	 ...
	 * @see InstagramConnectionFactory
	 */
	@Bean
